...
C            WRITE(6,*) KIN
     ...
     &               (Y.LT.BUTTON_YMAX(NB))) THEN
                     ...
                     IF(MODE.EQ. 3) CALL GAS2
                     IF(MODE.EQ. 4) CALL GAS3
                     IF(MODE.EQ. 5) CALL PLASMA0
                     IF(MODE.EQ. 6) CALL PLASMA1
                     IF(MODE.EQ. 7) CALL PLASMA2
                     IF(MODE.EQ. 8) CALL PLASMA3
                     IF(MODE.EQ. 9) CALL MAGNETIZE0
                     IF(MODE.EQ.10) CALL MAGNETIZE1
                     IF(MODE.EQ.11) CALL MAGNETIZE2
                     IF(MODE.EQ.12) CALL MAGNETIZE3
                     IF(MODE.EQ.13) CALL MAGNETIZE4
