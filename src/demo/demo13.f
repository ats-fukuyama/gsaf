...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@Gas, without collsion, reflected@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@Gas, without collision, periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_GAS_PARTICLES
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@Gas, with collision, reflected@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_GAS_PARTICLES
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@Gas, with collision, non-periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=0, without collsion, reflected@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=0, with collsion, reflected@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_PLASMA_PARTICLES
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=0, without collsion, periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=0, with collsion, non-periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_PLASMA_PARTICLESX
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=1, without collsion, periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_PLASMA_PARTICLESX
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=1, with collsion, periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_PLASMA_PARTICLES
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=1, without collsion, non-periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_PLASMA_PARTICLESX
...
C
         CALL MOVE( 5.0,15.5)
         CALL TEXTX('@B=1, with collsion, non-periodic@')
C
         XLEN=XMAX-XMIN
         YLEN=YMAX-YMIN
         CALL INIT_PLASMA_PARTICLESX
