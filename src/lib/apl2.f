...
C
      ...
      END
C
C     ****** DRAW SYMBOL ON GDEFIN COORDINATES ******
C
      SUBROUTINE MARK2D(X,Y)
C
      IMPLICIT LOGICAL(L)
      COMMON /GSGFXY/ DX,DY,PXS,PYS,PXE,PYE,GXS,GYS,GXE,GYE,LGF
C
...
C
      SUBROUTINE GNUMBI2D(X2D,Y2D,I,IJUST)
C
      IMPLICIT LOGICAL(L)
      COMMON /GSGFXY/ DX,DY,PXS,PYS,PXE,PYE,GXS,GYS,GXE,GYE,LGF
C
...
C
      X = DX*(X2D-GXS)+PXS
      Y = DY*(Y2D-GYS)+PYS
      CALL GNUMBI(X,Y,I,IJUST)
      RETURN
      END
C
C     ****** DRAW JUSTIFIED DOUBLE PRECISION REAL NUMBER ******
C
      SUBROUTINE GNUMBD2D(X2D,Y2D,D,IND,IJUST)
C
      IMPLICIT LOGICAL(L)
      COMMON /GSGFXY/ DX,DY,PXS,PYS,PXE,PYE,GXS,GYS,GXE,GYE,LGF
C
...
C
      SUBROUTINE GNUMBR2D(X2D,Y2D,R,IND,IJUST)
C
      IMPLICIT LOGICAL(L)
      COMMON /GSGFXY/ DX,DY,PXS,PYS,PXE,PYE,GXS,GYS,GXE,GYE,LGF
C
...
C
      X = DX*(X2D-GXS)+PXS
      Y = DY*(Y2D-GYS)+PYS
      CALL GNUMBD(X,Y,R,IND,IJUST)
      RETURN
      END
C
C     ****** DRAW JUSTIFIED INTEGER POWER ******
C
      SUBROUTINE GNUMBP2D(X2D,Y2D,I,J,IJUST)
C
      IMPLICIT LOGICAL(L)
      COMMON /GSGFXY/ DX,DY,PXS,PYS,PXE,PYE,GXS,GYS,GXE,GYE,LGF
C
