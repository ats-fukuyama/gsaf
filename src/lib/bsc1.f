...
C
C     *****************************************************
C     ****** GSAF BASIC ROUTINES V4.16 : INTERFACE 1 ******
C     *****************************************************
C
C     ****** SYSTEM INITIALIZE ******
C
...
C
      ...
      CALL GUTIMES(TUOPEN,TSOPEN,TCUOPEN,TCSOPEN,TELPOPEN)
...
C
      GXL = SNGL(LOG10(DBLE(GSTEP)*0.11D0))
      IF(GXL.LT.0.0) THEN
         NGX = -INT(-GXL)
      ELSE
         NGX =  INT(GXL)
